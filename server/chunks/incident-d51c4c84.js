import { c as create_ssr_component, g as compute_rest_props, h as spread, l as escape_attribute_value, i as escape_object, v as validate_component, e as escape, b as add_attribute, a as each } from './ssr-4803c1d8.js';
import { c as cn, v as validate_dynamic_element, d as validate_void_dynamic_element, i as is_void, C as Card, a as Card_content } from './Icon-3bd39a35.js';
import 'clsx';
import './ctx-5741cdfd.js';
import { S as StatusObj } from './helpers-0acb6e43.js';
import moment from 'moment';
import './index3-22015ff1.js';
import { B as Badge, a as Button } from './index4-a4b32e6b.js';
import { C as ChevronDown } from './chevron-down-9fe99d22.js';
...
const css = {
  code: ".toggle.s-OP_sZU419Za1.s-OP_sZU419Za1{display:none}.toggle.s-OP_sZU419Za1.s-OP_sZU419Za1{transition:all 0.15s ease-in-out}.toggle.open.s-OP_sZU419Za1.s-OP_sZU419Za1{transform:rotate(180deg)}.incident-div.s-OP_sZU419Za1:hover .toggle.s-OP_sZU419Za1{display:block}",
  map: null
};
const Incident = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="grid grid-cols-3 gap-4 mb-8 w-full incident-div s-OP_sZU419Za1"><div class="col-span-3">${validate_component(Card, "Card.Root").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=incident-d51c4c84.js.map
