import { c as create_ssr_component, e as escape, v as validate_component, a as each, g as compute_rest_props, d as validate_store, f as subscribe, h as spread, i as escape_object } from './ssr-4803c1d8.js';
import 'clsx';
import { I as Incident } from './incident-d51c4c84.js';
import { e as setCtx, f as getAttrs } from './ctx-5741cdfd.js';
import { c as cn } from './Icon-3bd39a35.js';
import 'moment';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="flex items-center justify-left"><p class="text-base font-semibold" data-svelte-h="svelte-fej0c3">No active incidents</p></div>`}</div></section> ${validate_component(Separator, "Separator").$$render($$result, { class: "container mb-4 w-[400px]" }, {}, {})} <section class="mx-auto flex-1 mt-8 flex-col mb-4 flex w-full"><div class="container"><h1 class="mb-4 text-2xl font-bold leading-none">${validate_component(Badge, "Badge").$$render($$result, { variant: "outline" }, {}, {
    default: () => {
  ...
  })}` : `<div class="flex items-center justify-left"><p class="text-base font-semibold" data-svelte-h="svelte-i57xwy">No recent incidents</p></div>`}</div></section>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-be543120.js.map
