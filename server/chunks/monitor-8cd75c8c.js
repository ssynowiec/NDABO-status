...
import 'clsx';
import { a as Button, B as Badge } from './index4-dc9ba479.js';
import { h as setCtx$2, i as getCtx$1, j as setCtx$1, k as getCtx, l as setItemCtx, m as getRadioIndicator, n as builder, o as getAttrs$3, p as getAttrs$2, q as getAttrs$1, r as addMeltEventListener } from './ctx-1da8879d.js';
import { d as derived } from './index2-ef0fcb8d.js';
import { c as createDispatcher } from './events-3e3c01b3.js';
import { b as buttonVariants } from './index3-db64c854.js';
...
const Monitor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="grid grid-cols-12 gap-4 w-full monitor pb-4 md:w-[890px]">${monitor.embed === void 0 ? `<div class="col-span-12 md:col-span-4"><div class="pt-1"><div class="scroll-m-20 text-2xl font-semibold tracking-tight">${monitor.image ? `<img${add_attribute("src", monitor.image, 0)} class="w-6 h-6 inline"${add_attribute("alt", monitor.name, 0)} srcset="">` : ``} <span>${escape(monitor.name)}</span> <br> ${monitor.description ? `${validate_component(Root, "Popover.Root").$$render($$result, {}, {}, {
      ...
      true
    ) + " md:col-span-4 text-right h-[32px]"}">${_90Day[todayDD] ? `<div class="${"text-api-up " + escape(monitor.embed === void 0 ? "md:pr-6" : "", true) + " text-sm truncate font-semibold mt-[4px] text-" + escape(_90Day[todayDD].cssClass, true) + " svelte-1nwu38p"}">${escape(_90Day[todayDD].message)}</div>` : ``}</div></div> ${`<div class="chart-status relative mt-1 col-span-12"><div class="flex overflow-x-auto daygrid90 overflow-y-hidden py-1 svelte-1nwu38p">${each(Object.entries(_90Day), ([ts, bar]) => {
...
export { Monitor as M };
//# sourceMappingURL=monitor-8cd75c8c.js.map
