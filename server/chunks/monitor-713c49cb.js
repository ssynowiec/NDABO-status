import { c as create_ssr_component, k as createEventDispatcher, b as add_attribute, e as escape, v as validate_component, a as each, g as compute_rest_props, d as validate_store, f as subscribe, h as spread, i as escape_object } from './ssr-4803c1d8.js';
import 'clsx';
import { a as Button, B as Badge } from './index4-a4b32e6b.js';
import { h as setCtx$2, i as getCtx$1, j as setCtx$1, k as getCtx, l as setItemCtx, m as getRadioIndicator, n as builder, o as getAttrs$3, p as getAttrs$2, q as getAttrs$1, r as addMeltEventListener } from './ctx-5741cdfd.js';
import { d as derived } from './index2-9a50040e.js';
import { c as createDispatcher } from './events-f8857eb2.js';
import { b as buttonVariants } from './index3-22015ff1.js';
import { c as cn, f as flyAndScale, I as Icon$1 } from './Icon-3bd39a35.js';
...
const css = {
  code: ".daygrid90.s-xP7x3srRFwOF.s-xP7x3srRFwOF{-ms-overflow-style:none;scrollbar-width:none}.daygrid90.s-xP7x3srRFwOF.s-xP7x3srRFwOF::-webkit-scrollbar{display:none}.oneline.s-xP7x3srRFwOF.s-xP7x3srRFwOF{transition:transform 0.1s ease-in;cursor:pointer}.oneline.s-xP7x3srRFwOF.s-xP7x3srRFwOF:hover{transform:scaleY(1.2)}.oneline.s-xP7x3srRFwOF:hover+.show-hover.s-xP7x3srRFwOF{display:block !important}.show-hover.s-xP7x3srRFwOF.s-xP7x3srRFwOF{display:none;top:40px;padding:0px;text-align:left}.today-sq+.hiddenx.s-xP7x3srRFwOF .message.s-xP7x3srRFwOF{position:absolute;white-space:nowrap}.today-sq.s-xP7x3srRFwOF+.hiddenx.s-xP7x3srRFwOF{visibility:hidden;z-index:30}.today-sq.s-xP7x3srRFwOF:hover+.hiddenx.s-xP7x3srRFwOF{visibility:visible}.today-sq.s-xP7x3srRFwOF.s-xP7x3srRFwOF:hover{box-shadow:rgba(50, 50, 105, 0.15) 0px 2px 5px 0px, rgba(0, 0, 0, 0.05) 0px 1px 1px 0px;opacity:0.75;transition:all 0.1s ease-in;cursor:pointer}.today-sq.s-xP7x3srRFwOF.s-xP7x3srRFwOF{position:relative;z-index:0}",
  map: null
};
const Monitor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `<div class="grid grid-cols-12 gap-4 w-full monitor pb-4 md:w-[890px]">${monitor.embed === void 0 ? `<div class="col-span-12 md:col-span-4"><div class="pt-1"><div class="scroll-m-20 text-2xl font-semibold tracking-tight">${monitor.image ? `<img${add_attribute("src", monitor.image, 0)} class="w-6 h-6 inline"${add_attribute("alt", monitor.name, 0)} srcset="">` : ``} <span>${escape(monitor.name)}</span> <br> ${monitor.description ? `${validate_component(Root, "Popover.Root").$$render($$result, {}, {}, {
      default: () => {
        return `${validate_component(Trigger, "Popover.Trigger").$$render($$result, {}, {}, {
          default: () => {
            return `<span class="${"pt-0 pl-1 menu-monitor pr-0 pb-0 " + escape(buttonVariants({ variant: "link" }), true) + " s-xP7x3srRFwOF"}">${validate_component(Info$1, "Info").$$render($$result, { size: 12, class: "text-muted-foreground" }, {}, {})}</span>`;
          }
      ...
      default: () => {
        return `${validate_component(Trigger, "Popover.Trigger").$$render($$result, {}, {}, {
          default: () => {
            return `<span class="${"pt-0 pl-1 pb-0 menu-monitor pr-0 " + escape(buttonVariants({ variant: "link" }), true) + " s-xP7x3srRFwOF"}">${validate_component(Share2, "Share2").$$render($$result, { size: 12, class: "text-muted-foreground" }, {}, {})}</span>`;
          }
    ...
    })}</div></div> <div class=""><div class="grid grid-cols-2 gap-0"><div class="col-span-1 -mt-2"><a href="${"/incident/" + escape(monitor.folderName, true) + "#past_incident"}" class="${"pt-0 pl-0 pb-0 text-indigo-500 text-left " + escape(buttonVariants({ variant: "link" }), true) + " s-xP7x3srRFwOF"}">Recent Incidents ${validate_component(ArrowRight, "ArrowRight").$$render($$result, { size: 16 }, {}, {})}</a></div></div></div></div>` : ``} <div class="${"col-span-12 md:w-[546px] " + escape(
      ...
      true
    ) + " md:col-span-4 text-right h-[32px]"}">${_90Day[todayDD] ? `<div class="${"text-api-up " + escape(monitor.embed === void 0 ? "md:pr-6" : "", true) + " text-sm truncate font-semibold mt-[4px] text-" + escape(_90Day[todayDD].cssClass, true) + " s-xP7x3srRFwOF"}">${escape(_90Day[todayDD].message)}</div>` : ``}</div></div> ${`<div class="chart-status relative mt-1 col-span-12"><div class="flex overflow-x-auto daygrid90 overflow-y-hidden py-1 s-xP7x3srRFwOF">${each(Object.entries(_90Day), ([ts, bar]) => {
      return `<div class="h-[30px] w-[6px] rounded-sm oneline s-xP7x3srRFwOF"><div class="${"h-[30px] bg-" + escape(bar.cssClass, true) + " w-[4px] rounded-sm mr-[2px] s-xP7x3srRFwOF"}"></div></div> <div class="absolute show-hover text-sm bg-background s-xP7x3srRFwOF"><div class="${"text-" + escape(bar.cssClass, true) + " font-semibold s-xP7x3srRFwOF"}">${bar.message != "No Data" ? `● ${escape(new Date(bar.timestamp * 1e3).toLocaleDateString())} ${escape(bar.message)}` : `● ${escape(new Date(bar.timestamp * 1e3).toLocaleDateString())} ${escape(bar.message)}`}</div> </div>`;
    })}</div></div>`}</div></div> </div>`;
  } while (!$$settled);
  return $$rendered;
});
...
export { Monitor as M };
//# sourceMappingURL=monitor-713c49cb.js.map
