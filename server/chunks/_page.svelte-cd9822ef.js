import { c as create_ssr_component, b as add_attribute, e as escape, v as validate_component, a as each } from './ssr-4803c1d8.js';
import { M as Monitor } from './monitor-713c49cb.js';
import { C as Card, a as Card_content } from './Icon-3bd39a35.js';
import { I as Incident, C as Card_header, a as Card_title, b as Card_description } from './incident-d51c4c84.js';
import 'clsx';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</section>` : ``} ${data.site.categories ? `<section class="mx-auto mb-8 w-full max-w-[890px] flex-1 flex-col items-start backdrop-blur-[2px]"><h2 class="mb-2 mt-2 px-2 text-xl font-semibold" data-svelte-h="svelte-3lfsa8">Other Monitors</h2> ${each(data.site.categories, (category) => {
...
//# sourceMappingURL=_page.svelte-cd9822ef.js.map
